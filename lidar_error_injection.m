...
%
%   Error Sources (all values from PDF architecture document):
%       1. Beam Splitter Polarisation Dependence  :  <5 %    (PDF §IV-A)
%       2. F-theta Lens Distortion                :  <0.1 %  (PDF §IV-B)
%       3. F-theta Wavefront Error                :  ≤0.1λ   (PDF §IV-B)
%       4. Optical Filter Angle Tolerance         :  ±5°     (PDF §V-B)
%       5. Optical Filter Temperature Stability   :  0.01 nm/°C (PDF §V-B)
%       6. Optical Filter Polarisation Dep.       :  <5%     (PDF §V-B)
%       7. TDC Linearity Error                    :  ±0.5 LSB   (PDF Table III)
%       8. Timing Jitter                          :  100 ps     (PDF §X-B)
%       9. Galvo Repeatability                    :  ±0.005°    (PDF §III-C)
...
scale_factors = [100, 100, 1, 1, 1, 100, 1, 1, 1];   % for display scaling
